...
export default function Footer() {
  return (
    <footer className="w-full border-t border-gray-800 bg-[#0b0b12] py-4">
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between px-4 text-sm text-gray-400">
        {/* Left side - logo */}
        <div className="flex items-center gap-3 mb-2 sm:mb-0">
          <Link href="/">
            <Image
              src="/images/logo.png"
              alt="Resume Builder Logo"
              width={60}  // ⬅️ increased from 36 to 60
              height={60} // ⬅️ increased from 36 to 60
              priority
        ...
        <div className="flex items-center gap-4">
          <p className="text-gray-500">
            © {new Date().getFullYear()} resume.com
          </p>
          <Link
            href="#0"
